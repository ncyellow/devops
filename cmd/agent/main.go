...
func main() {
	...
	flag.DurationVar(&cfg.ReportInterval, "r", time.Second*1, "send to server interval in the format 10s")
	flag.DurationVar(&cfg.PollInterval, "p", time.Second*1, "polling metrics interval in the format 2s")
